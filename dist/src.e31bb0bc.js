...
var render = function render(graph) {
  ...
  var searchParams = Object.fromEntries([search.split('=')]);
  ...
  var getCellClassName = function getCellClassName(cell) {
    return id ? "cell cell".concat(cell, "_").concat(id) : "cell cell".concat(cell);
  };
...
var clickHandler = function clickHandler(cell, isUser) {
  ...
  if (JSON.stringify(graph) === JSON.stringify(_graph.initialGraph) && isUser) {
